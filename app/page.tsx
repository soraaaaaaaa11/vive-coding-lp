      ...
      <section id="cta" className="py-20 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-gradient-to-r from-green-900/50 to-blue-900/50 p-8 rounded-2xl border border-green-500/30">
            ...
            {/* 友だち追加ボタン */}
            <a
              href="https://line.me/R/ti/p/@162jnuql"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-[#06C755] hover:bg-[#05b34c] text-white font-bold py-4 px-8 rounded-full text-lg transition-all transform hover:scale-105 shadow-lg mb-6"
            >
            ...
            <div className="hidden md:block">
              <p className="text-gray-400 text-sm mb-3">PCの方はQRコードをスキャン</p>
              <div className="w-40 h-40 bg-white mx-auto rounded-xl flex items-center justify-center overflow-hidden">
                <Image
